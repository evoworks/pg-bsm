...
tag = 'phyACF'; % assign a designator to the output files
...
grid on,box on,set(gcf,'pos',[320,290,1050,420])

H = figure(1); saveas(H,[path_to_data 'results\fig1_' tag '.png'])
...
H = figure(2); saveas(H,[path_to_data 'results\fig2_' tag '.png'])
...
H = figure(3); saveas(H,[path_to_data 'results\fig3_' tag '.png'])
...
H = figure(4); saveas(H,[path_to_data 'results\fig4_' tag '.png'])
...
fid = fopen([path_to_data 'results\BW_' tag '.txt'],'wt+');
...
H = figure(5); saveas(H,[path_to_data 'results\fig5_' tag '.png'])
...
fid = fopen([path_to_data 'results\CW_' tag '.txt'],'wt+');
...
H = figure(6); saveas(H,[path_to_data 'results\fig6_' tag '.png'])
...
fid = fopen([path_to_data 'results\rCW_' tag '.txt'],'wt+');
...
H = figure(7); saveas(H,[path_to_data 'results\fig7_' tag '.png'])

% make flat file

makeFlatFile([path_to_data 'results\'],CM,Output,['_' tag])
movefile([path_to_data 'results\Output_seq_' tag '.txt'],[path_to_data 'results\Output_' tag '.txt'])
